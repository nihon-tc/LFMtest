...
/**
 * JNA Wrapper for library <b>Di5Engine3</b>
 ...
 */
public interface Di5Engine3Library extends StdCallLibrary {
	...
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TRIAL_LOCK = (-3);
	/// <i>native declaration : inc\di5api.h</i>
	...
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_CUSTOM_ERROR = (-536870912);
	/// <i>native declaration : inc\di5api.h</i>
	...
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_LOCK = (-2);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_IMPLEMENTED = (Di5Engine3Library.D5_CUSTOM_ERROR | 501);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_LARGE_JOIN_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 104);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DETAIL_NOT_MADE = (Di5Engine3Library.D5_CUSTOM_ERROR | 156);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SET_UNASSIGNED = (Di5Engine3Library.D5_CUSTOM_ERROR | 129);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_MANY_USERS = (Di5Engine3Library.D5_CUSTOM_ERROR | 28);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_TREE = (Di5Engine3Library.D5_CUSTOM_ERROR | 250);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OVERFLOW_REAL = (Di5Engine3Library.D5_CUSTOM_ERROR | 100);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ALREADY_CLOSED = (Di5Engine3Library.D5_CUSTOM_ERROR | 153);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_TARGET = (Di5Engine3Library.D5_CUSTOM_ERROR | 55);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_SLAVE_FILTER = (Di5Engine3Library.D5_CUSTOM_ERROR | 108);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_OPERATION = (Di5Engine3Library.D5_CUSTOM_ERROR | 207);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DUPLICATE_TABLE_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 132);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_ROW_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 12);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ACCESS_DENIED = (Di5Engine3Library.D5_CUSTOM_ERROR | 152);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_COMMAND_AREA_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 234);
	/// <i>native declaration : inc\di5api.h</i>
	public static final int D5_MAX_TREE_QUALIFY = (Di5Engine3Library.D5_MAX_JOIN_CHAIN);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_JOINTABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 138);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_INVALID_OS_PARAM = (Di5Engine3Library.D5_CUSTOM_ERROR | 612);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_QUERY_TOO_LARGE_TEXT = (Di5Engine3Library.D5_CUSTOM_ERROR | 294);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_LARGE_ROW_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 13);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_PASSWORD_MAC_ADDRESS_MISMATCH = (Di5Engine3Library.D5_CUSTOM_ERROR | 702);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_MEMORY_IO = (Di5Engine3Library.D5_CUSTOM_ERROR | 289);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_SYNTAX_ERROR = (Di5Engine3Library.D5_CUSTOM_ERROR | 238);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_RANGE = (Di5Engine3Library.D5_CUSTOM_ERROR | 26);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_WIDTH = (Di5Engine3Library.D5_CUSTOM_ERROR | 10);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SUMMARY_IRREGULAR_DATA_DETECT = (Di5Engine3Library.D5_CUSTOM_ERROR | 322);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_FILEVERSION = (Di5Engine3Library.D5_CUSTOM_ERROR | 285);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SHMTBL_STANDBY = (Di5Engine3Library.D5_CUSTOM_ERROR | 609);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OVERFLOW_SET = (Di5Engine3Library.D5_CUSTOM_ERROR | 102);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DELETE_ROOT_SET = (Di5Engine3Library.D5_CUSTOM_ERROR | 134);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SMP_THREAD_ABORTED = (Di5Engine3Library.D5_CUSTOM_ERROR | 350);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_SET = (Di5Engine3Library.D5_CUSTOM_ERROR | 113);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_EDITING_HSS_FILTER_NOT_ALLOWED = (Di5Engine3Library.D5_CUSTOM_ERROR | 310);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_PASSWORD_FORMAT_ERROR = (Di5Engine3Library.D5_CUSTOM_ERROR | 701);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OUT_OF_RANGE = (Di5Engine3Library.D5_CUSTOM_ERROR | 284);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_TABLE_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 145);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_LOCALEID = (Di5Engine3Library.D5_CUSTOM_ERROR | 282);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SIGNAL_CAUGHT = (Di5Engine3Library.D5_CUSTOM_ERROR | 601);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_REFFERED_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 135);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OVERFLOW_JOIN = (Di5Engine3Library.D5_CUSTOM_ERROR | 101);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_CHARACTER_FOUND = (Di5Engine3Library.D5_CUSTOM_ERROR | 283);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_QUERY_SEMANTIC_ERROR = (Di5Engine3Library.D5_CUSTOM_ERROR | 292);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SHARED_MEMORY = (Di5Engine3Library.D5_CUSTOM_ERROR | 273);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ROW_SIZE_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 278);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_MANY_DATA = (Di5Engine3Library.D5_CUSTOM_ERROR | 21);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROE_UNINIT_PARAM = (Di5Engine3Library.D5_CUSTOM_ERROR | 140);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_FILTER_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 16);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MISMATCH_DATA = (Di5Engine3Library.D5_CUSTOM_ERROR | 147);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_SLAVE_SET = (Di5Engine3Library.D5_CUSTOM_ERROR | 115);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_OPERATION = (Di5Engine3Library.D5_CUSTOM_ERROR | 52);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_ALREADY_LOCKED = (Di5Engine3Library.D5_CUSTOM_ERROR | 613);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SUMMARY_NOT_NUM_MEASURE = (Di5Engine3Library.D5_CUSTOM_ERROR | 324);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_DATA_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 277);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_DBCODE = (Di5Engine3Library.D5_CUSTOM_ERROR | 281);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ALREADY_OPENED = (Di5Engine3Library.D5_CUSTOM_ERROR | 154);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_DATA_TYPE = (Di5Engine3Library.D5_CUSTOM_ERROR | 51);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_INNERJOIN = (Di5Engine3Library.D5_CUSTOM_ERROR | 144);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_LARGE_SUMMARY_ROW1 = (Di5Engine3Library.D5_CUSTOM_ERROR | 320);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_QUERY_INTERNAL_ERROR = (Di5Engine3Library.D5_CUSTOM_ERROR | 290);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_LARGE_SUMMARY_ROW2 = (Di5Engine3Library.D5_CUSTOM_ERROR | 321);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_NUMERICAL_FILTER = (Di5Engine3Library.D5_CUSTOM_ERROR | 231);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_STRING_ORDER = (Di5Engine3Library.D5_CUSTOM_ERROR | 23);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_EMPTY_SET = (Di5Engine3Library.D5_CUSTOM_ERROR | 148);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SUMMARY_DATA_NOT_DETECT = (Di5Engine3Library.D5_CUSTOM_ERROR | 323);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OVERFLOW_SLAVE = (Di5Engine3Library.D5_CUSTOM_ERROR | 103);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_REALTABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 137);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SHMTBL_REFERENCED = (Di5Engine3Library.D5_CUSTOM_ERROR | 610);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_DATA_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 117);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_INVALID_DATA = (Di5Engine3Library.D5_CUSTOM_ERROR | 275);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_JOIN_CHAIN = (Di5Engine3Library.D5_CUSTOM_ERROR | 146);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_TABLE_TYPE = (Di5Engine3Library.D5_CUSTOM_ERROR | 118);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MISMATCH_DATA_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 123);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MEMORY_LIMIT_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 27);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SHMTBL_READY = (Di5Engine3Library.D5_CUSTOM_ERROR | 608);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INNER_SYSTEM = (Di5Engine3Library.D5_CUSTOM_ERROR | 3);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_DIMSIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 209);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_QUERY_DATA_TYPE_MISMATCH = (Di5Engine3Library.D5_CUSTOM_ERROR | 293);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DATA_VERSION = (Di5Engine3Library.D5_CUSTOM_ERROR | 206);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_CATALOG_PARSE_ERROR = (Di5Engine3Library.D5_CUSTOM_ERROR | 274);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_SETID = (Di5Engine3Library.D5_CUSTOM_ERROR | 122);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SMCS_INIT = (Di5Engine3Library.D5_CUSTOM_ERROR | 603);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_UNDEFINED_TYPE = (Di5Engine3Library.D5_CUSTOM_ERROR | 276);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MEMORY_STREAM_CLOSE = (Di5Engine3Library.D5_CUSTOM_ERROR | 210);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ALREADY_DONE = (Di5Engine3Library.D5_CUSTOM_ERROR | 155);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MISMATCH_DATA_TYPE = (Di5Engine3Library.D5_CUSTOM_ERROR | 124);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DIR_INVALID_PATH = (Di5Engine3Library.D5_CUSTOM_ERROR | 150);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SUMMARY_NOT_MADE = (Di5Engine3Library.D5_CUSTOM_ERROR | 131);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DIR_NOT_EMPTY = (Di5Engine3Library.D5_CUSTOM_ERROR | 151);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_MASTER_FILTER = (Di5Engine3Library.D5_CUSTOM_ERROR | 107);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SEMAPHORE_REMOVED = (Di5Engine3Library.D5_CUSTOM_ERROR | 600);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SAVE_FILE_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 205);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_FILTER_AREA_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 232);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_CONST_AREA_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 233);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_MASTER_SET = (Di5Engine3Library.D5_CUSTOM_ERROR | 114);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OUT_OF_SUMMARY_AREA = (Di5Engine3Library.D5_CUSTOM_ERROR | 25);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALCPTR_STRING_AREA_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 240);
	/// <i>native declaration : inc\rdi5api.h</i>
	public static final int D5_SHMLOCK_WAIT = (Di5Engine3Library.D5_LOCK_WAIT);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_FILTER_ORDER = (Di5Engine3Library.D5_CUSTOM_ERROR | 19);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SQL_DB = (Di5Engine3Library.D5_CUSTOM_ERROR | 239);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_INDEX = (Di5Engine3Library.D5_CUSTOM_ERROR | 121);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_PASSWORD_EXPIRE_DATE_MISMATCH = (Di5Engine3Library.D5_CUSTOM_ERROR | 703);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_FIND_VERSION = (Di5Engine3Library.D5_CUSTOM_ERROR | 221);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_REALTABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 287);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_TABLE_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 119);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_RESOURCE_BUSY = (Di5Engine3Library.D5_CUSTOM_ERROR | 602);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_MEM_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 279);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OVERFLOW_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 99);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_CONVERT = (Di5Engine3Library.D5_CUSTOM_ERROR | 263);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_ROW_INDEX = (Di5Engine3Library.D5_CUSTOM_ERROR | 14);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 109);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SMCS_READY = (Di5Engine3Library.D5_CUSTOM_ERROR | 604);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_INVALID_OS = (Di5Engine3Library.D5_CUSTOM_ERROR | 272);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_DATA_TYPE = (Di5Engine3Library.D5_CUSTOM_ERROR | 116);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_PARAM = (Di5Engine3Library.D5_CUSTOM_ERROR | 130);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_FILEVERSION_NOT_EXIST = (Di5Engine3Library.D5_CUSTOM_ERROR | 286);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_UNKNOWN = (Di5Engine3Library.D5_CUSTOM_ERROR | 500);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_ROW_ORDER = (Di5Engine3Library.D5_CUSTOM_ERROR | 15);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_FILE_PATH = (Di5Engine3Library.D5_CUSTOM_ERROR | 142);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_ALIGNED_ADDRESS = (Di5Engine3Library.D5_CUSTOM_ERROR | 288);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DUPLICATE_FILTER_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 133);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_LARGE_FILTER_SIZE = (Di5Engine3Library.D5_CUSTOM_ERROR | 17);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_JOIN_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 112);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_TARGET_FILTER = (Di5Engine3Library.D5_CUSTOM_ERROR | 230);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_VALUE_ORDER = (Di5Engine3Library.D5_CUSTOM_ERROR | 2);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_DATA = (Di5Engine3Library.D5_CUSTOM_ERROR | 105);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_FIND_NOT_OPEN = (Di5Engine3Library.D5_CUSTOM_ERROR | 220);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_FILTER_COUNT = (Di5Engine3Library.D5_CUSTOM_ERROR | 127);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_STR_AREA_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 264);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_FILTER_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 54);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_TOO_MANY_D5TSHM_TABLES = (Di5Engine3Library.D5_CUSTOM_ERROR | 606);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SHMTBL_INIT = (Di5Engine3Library.D5_CUSTOM_ERROR | 607);
	/// <i>native declaration : inc\rdi5api.h</i>
	public static final int D5_SHMLOCK_NOWAIT = (Di5Engine3Library.D5_LOCK_NOWAIT);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_SUMMARY_NOT_SUITABLE_TOTAL = (Di5Engine3Library.D5_CUSTOM_ERROR | 325);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_VALUE = (Di5Engine3Library.D5_CUSTOM_ERROR | 1);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ADDFILTER2 = (Di5Engine3Library.D5_CUSTOM_ERROR | 204);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_INVALID_SHARED_OPERATION = (Di5Engine3Library.D5_CUSTOM_ERROR | 270);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_LOG_FAILURE = (Di5Engine3Library.D5_CUSTOM_ERROR | 811);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_FILESIZE_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 704);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_NUM_STACK_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 261);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ILLEGAL_TABLE_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 53);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_FILE_IO = (Di5Engine3Library.D5_CUSTOM_ERROR | 141);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_TOO_LARGE_D5T_FILE = (Di5Engine3Library.D5_CUSTOM_ERROR | 614);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MISMATCH_FILTER = (Di5Engine3Library.D5_CUSTOM_ERROR | 128);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DIR_ALREADY_EXIST = (Di5Engine3Library.D5_CUSTOM_ERROR | 149);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_FILTER_INDEX = (Di5Engine3Library.D5_CUSTOM_ERROR | 18);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_QUERY_SYNTAX_ERROR = (Di5Engine3Library.D5_CUSTOM_ERROR | 291);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_DATATABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 208);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_FILTER = (Di5Engine3Library.D5_CUSTOM_ERROR | 106);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_DUPLICATE_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 611);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_FILTERID = (Di5Engine3Library.D5_CUSTOM_ERROR | 136);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_MASTER_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 110);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NOT_TABLE_NAME = (Di5Engine3Library.D5_CUSTOM_ERROR | 143);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_ALREADY_EXIST = (Di5Engine3Library.D5_CUSTOM_ERROR | 280);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_OUT_OF_MEMORY = (Di5Engine3Library.D5_CUSTOM_ERROR | 24);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_TOO_LONG_STRING = (Di5Engine3Library.D5_CUSTOM_ERROR | 22);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_CORBA_COMM_FAILURE = (Di5Engine3Library.D5_CUSTOM_ERROR | 242);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_WARNING_D5TSHM_SHMTBL_INIT = (Di5Engine3Library.D5_CUSTOM_ERROR | 615);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_INVALID_SHARED_FILE = (Di5Engine3Library.D5_CUSTOM_ERROR | 271);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_MISMATCH_TABLE_TYPE = (Di5Engine3Library.D5_CUSTOM_ERROR | 126);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_PRG_STACK_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 262);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_GET_PROJECTION = (Di5Engine3Library.D5_CUSTOM_ERROR | 202);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_DIR_NOTFOUND = (Di5Engine3Library.D5_CUSTOM_ERROR | 4);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_D5TSHM_SMCS_ACTIVE = (Di5Engine3Library.D5_CUSTOM_ERROR | 605);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_INVALID_HANDLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 57);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_CALC_STR_STACK_OVERFLOW = (Di5Engine3Library.D5_CUSTOM_ERROR | 260);
	/// <i>native declaration : inc\di5error.h</i>
	public static final int D5_ERROR_NO_SLAVE_TABLE = (Di5Engine3Library.D5_CUSTOM_ERROR | 111);
	/**
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5ClearDB()</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5AddRealTable(const char[D5_MAX_NAME_LENGTH], const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5SaveRealTable(const char[D5_MAX_PATH], const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5DeleteTable(const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5GetTableProperty(const int, TTableInfo*)</code>
	 ...
	 * @deprecated use the safer methods {@link #RD5ExtractRealTableEx(byte[], int, int, int, int, int[])} and {@link #RD5ExtractRealTableEx(com.sun.jna.Pointer, int, int, int, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@java.lang.Deprecated 
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5CondenseRealTable(const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5GetTotalRows(const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5PurgeSubsets(const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5GetSetSize(const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5GetJoinDir(const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5GetFilterWidth(const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5DupRealFilterEx(const int, const int, const int)</code>
	 ...
	 * @deprecated use the safer methods {@link #RD5AppendCatalogFileEx2(int, int, int, byte[], byte[], byte[], byte[])} and {@link #RD5AppendCatalogFileEx2(int, int, int, com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer)} instead
	 */
	@java.lang.Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #RD5AddCatalogFileEx2(byte[], byte[], byte[], byte[], byte[])} and {@link #RD5AddCatalogFileEx2(com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer)} instead
	 */
	@java.lang.Deprecated 
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5MoveSlaveFlt2Master(const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5FindRecNoReal(const int, const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5OpenStrFindRealSJIS(const int, const int, const int, const char[D5_MAX_STRING_SIZE], const char[D5_MAX_STRING_SIZE])</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5CloseFindReal(const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5AddCategoryReal(const int, const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5InsertRealRows(const int, const int, const int)</code>
	 ...
	 * Original signature : <code>__stdcall D5RESULT RD5GetData1(const int, const int, const int, const int, int*, char[D5_MAX_STRING_SIZE + 1])</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5SearchByDispRowNoReal(const int, const int, const int, const int, const int)</code>
	 ...
	 * Original signature : <code>__stdcall D5RESULT RD5SearchByField(const int, const int, const int, const int, const void*, const void*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5SearchByText(const int, const int, const char[D5_MAX_SEARCH_TEXT_SIZE])</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5SortByField(const int, const int, const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5GetFilterIDFromName(const int, const char[D5_MAX_NAME_LENGTH])</code>
	 * <i>native declaration : inc\rdi5api.h:2356</i>
	 * @deprecated use the safer methods {@link #RD5GetFilterIDFromName(int, byte[])} and {@link #RD5GetFilterIDFromName(int, com.sun.jna.Pointer)} instead
	 */
	@java.lang.Deprecated 
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5SetTailSpaceFlag(const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5SetDBCharCode(const char*)</code>
	 ...
	 * @deprecated use the safer methods {@link #RD5GetD5TFileInfo(byte[], byte[], di5engine3.D5FileInfo)} and {@link #RD5GetD5TFileInfo(com.sun.jna.Pointer, com.sun.jna.Pointer, di5engine3.D5FileInfo)} instead
	 */
	@java.lang.Deprecated 
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * スクリプト言語ではサポートしません。
	 * Original signature : <code>__stdcall D5RESULT RD5BrowserPutFile(const char[D5_MAX_NAME_LENGTH], const int, const char[D5_MAX_TEXT_SIZE])</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5Shutdown()</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5HighSpeedSearchSetMark(const int, const int, const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5HighSpeedSearchHasMark(const int, const int, const int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULT RD5HighSpeedSearchEnable(const int, const int, const int)</code>
	 ...
	 * @deprecated use the safer methods {@link #RD5SetPassword(byte[])} and {@link #RD5SetPassword(com.sun.jna.Pointer)} instead
	 */
	@java.lang.Deprecated 
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULTL RD5GetLimitRowSize()</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall D5RESULTL RD5GetLimitMemSize()</code>
	 ...
	 * Original signature : <code>__stdcall D5RESULT RD5ReInitializeMS()</code>
	 ...
	 * @retval	0以上	整数・浮動小数点型：取得した行のうち、単一で最大のデータサイズ(byte) 文字列型：NULL終端を含まない最終行のデータサイズ(byte)
	 * @retval	負		エラーコード
	 * Original signature : <code>__stdcall D5RESULT RD5GetData1MEx(const int, const int, const int, const int, const int, const int, int*, int*, void*, char*)</code>
	 * @param TableID IN:テーブルＩＤ
	 * @param FltID IN:FilterID
	 * @param SetID IN:-1 ならカレントセット
	 ...
	 * 　計算結果を配列もらいます
	 * ErrorRepは無効なので空文字列を指定してください。
	 * Original signature : <code>__stdcall D5RESULT RD5CalcPtr(const int, const int, const int, const int, const char[D5_MAX_STRING_SIZE], const int, void*, size_t, char*, char[D5_MAX_STRING_SIZE])</code>
	 * @param iResultDataType 計算結果データのタイプ	int=3,・・・
	 ...
	 * @retval	0	成功
	 * @retval	負	エラーコード
	 * Original signature : <code>__stdcall D5RESULT RD5SaveRealTable2Mem(const int, const void*, const size_t, void**)</code>
	 ...
	 * @retval	0	成功
	 * @retval	負	エラーコード
	 * Original signature : <code>__stdcall D5RESULT RD5SaveDB2Mem(const void*, const size_t, void**)</code>
	 ...
	 * @retval	0	成功
	 * @retval	負	エラーコード
	 * Original signature : <code>__stdcall D5RESULT RD5LoadDBFromMem(const void*, void**)</code>
	 ...
	 * @retval	0 　成功
	 * @retval	負	エラーコード
	 * Original signature : <code>__stdcall D5RESULT RD5ResetSetID(const int, const int)</code>
	 * <i>native declaration : inc\rdi5api.h:4149</i>
	 */
	int RD5ResetSetID(int nTableID, int nNewSetID);
	/**
	 * バージョン情報を取得します。
	 * @param[out]	anVersion	バージョン配列
	 * @retval	0	常に0
	 ...
	 * Original signature : <code>__stdcall int RD5GetVersionR1(int*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GetCopyRightR1()</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GetDBPathR1()</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GetDBNameR1()</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GenerateTableNameR1(char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5SearchByFieldStrR1(int, int, int, int, char*, char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5SearchByFieldIntR1(int, int, int, int, int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5SearchByFieldDblR1(int, int, int, int, double, double)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5SearchByFieldNumericR1(int, int, int, int, Numeric*, Numeric*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5SearchByFieldSJISR1(int, int, int, int, char*, char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5SearchByFieldLocaleR1(int, int, int, int, char*, char*, int)</code>
	...
	/**
	 * Original signature : <code>__stdcall int RD5GetDataIntR1(int, int, int, int)</code>
	 * <i>native declaration : inc\rdi5apiext.h:169</i>
	 */
	int RD5GetDataIntR1(int nTableID, int nFilterID, int nSetID, int nRowNo);
	/**
	 * Original signature : <code>__stdcall double RD5GetDataDblR1(int, int, int, int)</code>
	...
	/**
	 * Original signature : <code>__stdcall int RD5GetDataNumericR1(int, int, int, int, Numeric*)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5GetNumericInfoR1(int, int, NumericInfo*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5GetData1IntR1(int, int, int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall double RD5GetData1DblR1(int, int, int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GetData1StrR1(int, int, int, int)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5GetData1NumericR1(int, int, int, int, Numeric*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GetFilterNameR1(int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5OverwriteRealExIntR1(int, int, int, int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5OverwriteRealExDblR1(int, int, int, int, double)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5OverwriteRealExNumericR1(int, int, int, int, Numeric*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5OverwriteRealExStrR1(int, int, int, int, char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5FillRealExIntR1(int, int, int, int, int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5FillRealExDblR1(int, int, int, int, int, double)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * pWriteDataは、lfmutilの{@link CNumeric}を使用してポインタを指定してください。
	 * Original signature : <code>__stdcall int RD5FillRealExNumericR1(int, int, int, int, int, Numeric*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall int RD5FillRealExStrR1(int, int, int, int, int, char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>char* RD5GetData1Cnv2StrR1(int, int, int, int)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall double RD5Str2DateR1(char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall double RD5Str2TimeR1(char*)</code>
	 ...
	 * @par	スクリプト言語から使用する際の注意事項:
	 * 特になし
	 * Original signature : <code>__stdcall double RD5Str2DateTimeR1(char*)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5GetData1MIntR1(int, int, int, int, int*, int*)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5GetData1MDblR1(int, int, int, int, int*, double*)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5GetData1MNumericR1(int, int, int, int, int*, Numeric*)</code>
	 ...
	 * Original signature : <code>__stdcall int RD5GetData1MStrR1(int, int, int, int, int*, int*, void*)</code>
	...
	/**
	 * Original signature : <code>__stdcall int RD5GetJoinInfoR1(int, int*, int*, int*, int*, int*, int*)</code>
	 ...
	 *  lfmutilの{@link CTypeIntAr}を使用してポインタを指定してください。
	 * Original signature : <code>__stdcall int RD5GetJoinInfoExR1(int, int*, int*, int*, int*, int[D5_MAX_JOIN_KEY], int*, int*, int[D5_MAX_JOIN_KEY])</code>
	 * @param nTableID IN:指定のテーブルのテーブルID
	 * @param pnIsOuter OUT:OuterJoin=1, InnerJoin=0
	 * @param pnJoinKeyCount OUT:JoinKey's count
	 * @param pnMasterTableID OUT:指定のテーブルのマスターテーブルID
	 * @param pnMasterSetID OUT:指定のテーブルのマスター集合ID
	 * @param anMasterFilterIDs OUT:JOINKEYのFilter-ID配列（領域は呼び出し側で）
	 * @param pnSlaveTableID OUT:指定のテーブルのスレーブテーブルID
	 * @param pnSlaveSetID OUT:指定のテーブルのスレーブ集合ID
	 * @param anSlaveFilterIDs OUT:JOINKEYのFilter-ID配列（領域は呼び出し側で）
	...
	/**
	 * Original signature : <code>__stdcall int RD5Connect2LFMServer(int, char*)</code>
	...
	/**
	 * Original signature : <code>__stdcall int RD5DisconnectFromLFMServer()</code>
